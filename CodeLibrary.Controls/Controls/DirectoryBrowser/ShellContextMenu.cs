...
namespace CodeLibrary.Controls.DirectoryBrowser
{
    ...
    public class ShellContextMenu
    {
        ...
        protected IntPtr[] GetPIDLs(FileInfo[] arrFI)
        {
            ...
            string dir = arrFI[0].DirectoryName;
            if (string.IsNullOrEmpty(dir))
                dir = string.Empty;

            IShellFolder oParentFolder = GetParentFolder(dir);
        ...
        [DllImport("shlwapi.dll", EntryPoint = "StrRetToBufA", ExactSpelling = false, CharSet = CharSet.Auto, SetLastError = true)]
        private static extern Int32 StrRetToBufA(IntPtr pstr, IntPtr pidl, StringBuilder pszBuf, int cchBuf);
